...
[![Count Badge](https://index.scala-lang.org/count.svg?q=dependencies:typelevel/cats&subject=cats&color=orange&style=flat-square)](https://index.scala-lang.org/search?q=dependencies:akka/akka-actor)
