...
[![Count Badge](https://index.scala-lang.org/count.svg?q=dependencies:akka/akka-actor&subject=akka-actors&color=orange&style=flat-square)](https://index.scala-lang.org/count.svg?q=dependencies:akka/akka-actor)
