...
package object bintray {
  ...
  val bintrayIndexBase = build.info.BuildInfo.baseDirectory.toPath
    .resolve(Paths.get("index", "bintray"))
  ...
  val indexBase =
    build.info.BuildInfo.baseDirectory.toPath.resolve(Paths.get("index"))
}
