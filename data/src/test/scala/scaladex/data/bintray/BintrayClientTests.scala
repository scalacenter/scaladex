...
import scaladex.data.bintray.BintrayClient
...
class BintrayClientTests extends AnyFlatSpec with Matchers {
  "BintrayClient" should "calculate pagination properly" in {
    ...
    getPagination(
      ...
      endPos = 99,
      total = 100
    ) should contain theSameElementsAs Nil
    getPagination(
      startPos = 0,
      endPos = 49,
      total = 50
